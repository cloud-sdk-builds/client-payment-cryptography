...
[`@aws-sdk/client-payment-cryptography`](https://www.npmjs.com/package/@aws-sdk/client-payment-cryptography/v/3.690.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-payment-cryptography@3.690.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8xLGgT92xfLiaqXSBgB3Rk0rPTFT+YmDTj625YzUSHRtrIUdtvgkxc48D9hGfEnI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-payment-cryptography": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-payment-cryptography@3.690.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-payment-cryptography@3.690.0/index.min.mjs": "sha384-8xLGgT92xfLiaqXSBgB3Rk0rPTFT+YmDTj625YzUSHRtrIUdtvgkxc48D9hGfEnI"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.690.0`)
...
```
https://github.com/cloud-sdk-builds/client-payment-cryptography/blob/refs/tags/3.690.0/LICENSE
```
